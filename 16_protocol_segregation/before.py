...
def check_status(devices: dict[str, Device]) -> None: # problematic because check_status expects devices and device protocol implements check_status
...
def main() -> None:
    ...
    # try to check_status of status_sources obj
    check_status(status_sources) # only check_status, doesn't send_messages
